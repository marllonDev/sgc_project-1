...
public interface ColaboradorRepository extends JpaRepository<Colaborador, Integer> {
    ...
    @Query(value = "select new com.basis.sgcproject.service.dto.ColaboradorCompetenciaNivelMaximoListDto(cc.id.idColaborador, cc.colaborador.nome, cc.colaborador.sobrenome, cc.id.idCompetencia, cc.competencia.nome, cc.nivel) from ColaboradorCompetencia cc where cc.nivel=2")
