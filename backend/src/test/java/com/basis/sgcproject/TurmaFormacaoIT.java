...
public class TurmaFormacaoIT {
    ...
    public void setUp() {
        ...
        RestAssured.basePath = "/api/turmas";
        inserirCompetencias();
        inserirColaboradores();
    }

    @Test
    public void deveRetornarStatus200_QuandoListarTurmas() {
        RestAssured.given()
    ...
    @Test
    public void deveRetornarStatus200_QuandoBuscarTurmaPorId() {
        RestAssured.given()
                .pathParam("turmaId", 1)
                .accept(ContentType.JSON)
                .when()
    ...
    @Test
    public void deveRetornarStatus201_QuandoCriarNovaTurma() {
        RestAssured.given()
                .body("{\n" +
                        "    \"nome\": \"Turma XX\",\n" +
    ...
    @Test
    public void deveRetornarStatus200_QuandoAtualizarTurma() {
        RestAssured.given()
                .pathParam("turmaId", 1)
                .body("{\n" +
                        "    \"nome\": \"Turma 10\",\n" +
    ...
    @Test
    public void deverRetornarStatus204_QuandoExcluirTurma() {
        RestAssured.given()
                .pathParam("turmaId", 1)
                .when()
                .delete("/{turmaId}")
    ...
    @Test
    public void deveFalharAoTentarExcluirTurma_ComStatusIniciada() {
        TurmaFormacao turma = turmaFormacaoRepository.findByStatusId(2);
        Assertions.assertThrows(RegraNegocioException.class, () ->
                turmaFormacaoService.excluir(turma.getStatus().getId()));
    }

    @Test
    public void deveFalharAoSalvarTurma_SemNome() {
        RestAssured.given()
                .body("{\n" +
                        "    \"nome\": \"\",\n" +
                        "    \"descricao\": \"Sera ensinado Angular\",\n" +
    ...
    @Test
    public void deveFalharAoSalvarTurma_SemCompetenciaColaborador() {
        RestAssured.given()
                .body("{\n" +
                        "    \"nome\": \"Turma 11\",\n" +
                        "    \"descricao\": \"Sera ensinado Angular\",\n" +
